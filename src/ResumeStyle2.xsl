	...
	<div id="inner">
		...
		<div class="yui-u">
			<div class="contact-info">
				...
				<h3>
					<i> Address: </i> <xsl:value-of select = "resume/personal/address" />
				</h3>
				<h3>
					<i> City: </i> <xsl:value-of select = "resume/personal/city" />
				</h3>
				<h3>
					<i> State: </i> <xsl:value-of select = "resume/personal/state" />
				</h3>
				<h3>
					<i> Zip Code: </i> <xsl:value-of select = "resume/personal/zip" />
				</h3>
			</div>
           ...
           <div class = "yui-u">
						...
						<xsl:choose>
							<xsl:when test = "resume/experience/e">
								...
								<h5><xsl:value-of select = "companycity" /> 
									<xsl:value-of select = "companystate" /></h5>
								<h4><xsl:value-of select = "companystart" />
									<xsl:value-of select = "companyend" /> </h4>
								</div>
								</xsl:for-each>
							</xsl:when>
           ...
           <div class = "yui-u">
						...
						<xsl:choose>
							<xsl:when test = "resume/education/ed">
								...
								<div class="job">
								<h2><xsl:value-of select = "school" /></h2>
								<h3><xsl:value-of select = "degree" /></h3>
								<h5><xsl:value-of select = "schoolcity" /> 
									<xsl:value-of select = "schoolstate" /></h5>
								<h4><xsl:value-of select = "schoolstart" />
									<xsl:value-of select = "schoolend" /> </h4>
								</div>
								</xsl:for-each>
							</xsl:when>
           ...
           <div class = "yui-u">
						...
						<xsl:choose>
							<xsl:when test = "resume/achievement/a">
								...
								<div class="job">
								<h2> <xsl:value-of select = "achieve" /></h2>
								<p><xsl:value-of select = "achievedescription" /></p>
								</div>
								</xsl:for-each>
							</xsl:when>
           ...
           <div class = "yui-u">
						...
						<xsl:choose>
							<xsl:when test = "resume/skill/s">
								...
								<div class="job">
								<h2> <xsl:value-of select = "skilltype" /></h2>
