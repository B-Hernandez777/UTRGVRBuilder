...
import vaqpack.model.BusinessCardStyle;
...

{
	...
	@FXML ListView<BusinessCardStyle> styleListView;
	
	private ObservableList<BusinessCardStyle> styleList = FXCollections.observableArrayList(new BusinessCardStyle("Style 1"), new BusinessCardStyle("Style 2"));
		 ...
		 styleListView.getSelectionModel().selectedItemProperty().addListener(e->
	        {
	        	...
	        	{
	        		BusinessCardStyle selected = styleListView.getSelectionModel().getSelectedItem();
