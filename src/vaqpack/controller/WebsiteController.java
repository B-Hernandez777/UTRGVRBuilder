...

{
	...
	@FXML ListView<WebsiteStyle> styleListView;
	
	private ObservableList<WebsiteStyle> styleList = FXCollections.observableArrayList(new WebsiteStyle("Style 1"), new WebsiteStyle("Style 2"));
		 ...
		 styleListView.getSelectionModel().selectedItemProperty().addListener(e->
	        {
	        	...
	        	{
	        		WebsiteStyle selected = styleListView.getSelectionModel().getSelectedItem();
